  ...
  return (
    <section className="px-3 pb-4 pt-3">
      <button
        ...
        className="relative block w-full overflow-hidden rounded-[14px] bg-gradient-to-r from-[#fbf1ef] via-[#fff8f5] to-[#f6ddcf] text-left shadow-[0_8px_20px_rgba(122,31,54,0.08)]"
      >
        {banner?.image && (
          <img
