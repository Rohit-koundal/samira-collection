...
export default function Reviews() {
  ...
  return (
    <section className="space-y-5">
      ...
      {loadError ? <PageState error={loadError} onRetry={load} /> : <DataTable loading={loading} emptyTitle="No reviews found" heads={['Product', 'Customer', 'Rating', 'Review', 'Signals', 'Status', 'Date', 'Actions']} rows={filtered.map((review) => (
